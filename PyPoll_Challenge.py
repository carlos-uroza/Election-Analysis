...
with open(file_to_save, "w") as txt_file:
    ...
    for counties in counties_votes:
        ...
        county_votes = counties_votes[counties]
        ...
        county_results = (
            f"{counties}: {county_percentage:.1f}% ({county_votes:,})\n")
    ...
    for candidate_options in candidate_votes:
        ...
        votes = candidate_votes[candidate_options]
        vote_percentage = float(votes) / float(total_votes) * 100
        candidate_results = (
            f"{candidate_options}: {vote_percentage:.1f}% ({votes:,})\n")
        ...
        if (votes > winning_count) and (vote_percentage > winning_percentage):
            winning_count = votes
            winning_candidate = candidate_options
